...
3. The dataframe is splitted using `TimeSeriesSplit` as the cross validation method.
...
![alt text](images/electricity_prediction_test-data.png)
...
![alt text](images/feature_importance_forecasting.png)
