...
This data shows the increasing trends of the total electricity generated by nuclear power plants (NPP).
...
This plot shows how total electricity generated by nuclear energy and the capacity factor are related to the month of the year. The pattern of the data shows how the electricity generation and capacity factor of nuclear energy are at its peak on **summer** and **winter** season, where the demand of electricity to use wether an air conditioner on summer and heater on winter are high. 
